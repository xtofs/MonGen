...
using System.Linq;
using SampleDataGenerators.Extensions;
using RegexAstParsers;
using RegexAstParsers.ParserCombinators;

namespace MonoGen.DataGeneration
{
    public static class Generators
    {
        // TODO : replace with generators based on RegexAST
        ...
        //public static readonly string Alpha = LowerCaseAlpha + UpperCaseAlpha;
        //public static readonly string AlphaNumeric = Numeric + Alpha;
        //public static IGenerator<string> Name => String("ABCDEFGHIJKLMNOPQRST", "abcdefghijklmnopqrst", 3, 12);

        //public static IGenerator<string> Identifier => String(Alpha + "_", AlphaNumeric + "_", 3, 12);


        //public static IGenerator<string> String(string first, string rest, int minLength, int maxLength)
        //{
        //    return
        //        from head in Char(first)
        //        from tail in Char(rest).Sequence(minLength, maxLength)
        //        select $"{head}{tail}";
        //}
        ...
        public static IGenerator<string> String(string regex)
        {
            var ast = RegexAstParsers.RegexAstParsers.Alternatives.Parse(regex);
